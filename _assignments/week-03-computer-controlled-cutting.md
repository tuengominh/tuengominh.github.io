...
<p>For the <strong>Material Settings</strong> in <a href="https://www.troteclaser.com/en/laser-machines/laser-software/jobcontrol/">TROTEC JobControl</a>, we followed the information on the Laser Cut Sample at the Fab Lab. The parts to be engraved (rastered) were color-coded with black, and the parts to be cut were color-coded with red.</p> 
